...
namespace ProlimpieAPI.Services.sysAdmin
{
    ...
    {
        Task<List<PermisosDTO>> GetPermisosGrid();
    }
    ...
    public class  PermisosService : IPermisosService
    {
        ...
        public PermisosService(AppDbContext appDbContext)
        {
            _appDbContext = appDbContext;
        }

        public async Task<List<PermisosDTO>> GetPermisosGrid()
        {
            return await (
